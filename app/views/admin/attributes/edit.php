    ...
    <div class="flex">
        ...
        <div class="flex-1 p-10">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="<?php echo BASE_URL; ?>/admin/productAttribute" class="text-blue-500 hover:text-blue-700">&larr; Quay lại danh sách thuộc tính</a>
            </div>
            <?php flash('attribute_message'); ?>

            <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow">
                <form action="<?php echo BASE_URL; ?>/admin/productAttribute/update/<?php echo $data['attribute']->id; ?>" method="POST">
                    <div class="mb-6">
