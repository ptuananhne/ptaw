...
REPLACE INTO `admins` (`id`, `username`, `email`, `password_hash`, `created_at`) VALUES
	(1, 'admin', 'admin@example.com', '$2y$10$IflpBvY8sF.T3jT8EwO.A.Vqg9zP7kX5C.L6mJ2.N.U8eW4oG3o.q', '2025-07-05 04:52:08');
...
REPLACE INTO `banners` (`id`, `image_url`, `link_url`, `title`, `is_active`, `created_at`) VALUES
	(1, 'uploads/banners/summer-sale.png', '/category/dien-thoai', 'Summer Sale Banner', 1, '2025-07-06 02:43:47');
...
REPLACE INTO `brands` (`id`, `name`, `slug`, `logo_url`, `created_at`, `updated_at`) VALUES
	...
	(6, 'Sony', 'sony', 'uploads/brands/sony-logo.png', '2025-07-05 04:52:08', '2025-07-05 04:52:08');
...
REPLACE INTO `categories` (`id`, `name`, `slug`, `created_at`, `updated_at`) VALUES
	(1, 'Điện thoại', 'dien-thoai', '2025-07-05 04:52:08', '2025-07-05 04:52:08'),
	(2, 'Laptop', 'laptop', '2025-07-05 04:52:08', '2025-07-05 04:52:08'),
	(3, 'Xe máy', 'xe-may', '2025-07-05 04:52:08', '2025-07-05 04:52:08');
...
REPLACE INTO `products` (`id`, `name`, `slug`, `description`, `specifications`, `image_url`, `category_id`, `brand_id`, `view_count`, `price`, `created_at`, `updated_at`) VALUES
	(1, 'iPhone 15 Pro Max 256GB', 'iphone-15-pro-max-256gb', 'Mô tả chi tiết cho iPhone 15 Pro Max...', '{"Màn hình": "OLED 6.7 inch", "Chip": "Apple A17 Pro"}', 'uploads/products/iphone-15.jpg', 1, 1, 261, 32000000, '2025-07-06 06:14:28', '2025-07-06 08:54:15'),
	(2, 'Samsung Galaxy S24 Ultra', 'samsung-galaxy-s24-ultra', 'Mô tả chi tiết cho Samsung Galaxy S24 Ultra...', '{"Màn hình": "Dynamic AMOLED 2X 6.8 inch", "Chip": "Snapdragon 8 Gen 3"}', 'uploads/products/s24-ultra.jpg', 1, 2, 235, 29500000, '2025-07-06 06:14:28', '2025-07-06 06:14:28'),
	...
	(4, 'Samsung Galaxy Z Fold 5', 'samsung-galaxy-z-fold-5', 'Điện thoại gập cao cấp nhất từ Samsung.', '{"Màn hình chính": "7.6 inch Foldable Dynamic AMOLED 2X", "Chip": "Snapdragon 8 Gen 2"}', 'uploads/products/z-fold-5.jpg', 1, 2, 150, 40990000, '2025-07-06 06:14:28', '2025-07-06 06:14:28'),
	...
	(12, 'MacBook Air 13 inch M2', 'macbook-air-13-m2', 'Mỏng nhẹ, mạnh mẽ, thời lượng pin cả ngày.', '{"CPU": "Apple M2", "RAM": "8 GB", "Ổ cứng": "256 GB SSD"}', 'uploads/products/macbook-air-m2.jpg', 2, 1, 220, 26500000, '2025-07-06 06:14:28', '2025-07-06 06:14:28'),
	...
	(18, 'iMac 24 inch M3', 'imac-24-m3', 'Máy tính All-in-One mạnh mẽ và đầy màu sắc.', '{"CPU": "Apple M3", "RAM": "8 GB", "Ổ cứng": "256 GB SSD"}', 'uploads/products/imac-24.jpg', 2, 1, 110, 33490000, '2025-07-06 06:14:28', '2025-07-06 06:14:28'),
	(19, 'Honda Vision 2024', 'honda-vision-2024', 'Mô tả chi tiết cho xe Honda Vision 2024...', '{"Động cơ": "eSP+ 4 van", "Dung tích": "110cc"}', 'uploads/products/honda-vision.jpg', 3, 4, 369, 32000000, '2025-07-06 06:14:28', '2025-07-06 08:05:11'),
	(20, 'Honda Air Blade 160', 'honda-air-blade-160', 'Thiết kế thể thao, động cơ mạnh mẽ.', '{"Động cơ": "eSP+ 4 van", "Dung tích": "160cc"}', 'uploads/products/air-blade-160.jpg', 3, 4, 320, 58000000, '2025-07-06 06:14:28', '2025-07-06 06:14:28'),
	...
	(23, 'Toyota Corolla Cross 1.8V', 'toyota-corolla-cross-1-8v', 'SUV đô thị bán chạy nhất.', '{"Động cơ": "1.8L Dual VVT-i", "Hộp số": "CVT"}', 'uploads/products/corolla-cross.jpg', 3, 5, 260, 860000000, '2025-07-06 06:14:28', '2025-07-06 06:14:28'),
	(24, 'Honda Winner X', 'honda-winner-x', 'Xe côn tay thể thao, hiệu suất cao.', '{"Động cơ": "DOHC 150cc", "Hộp số": "6 cấp"}', 'uploads/products/winner-x.jpg', 3, 4, 290, 46000000, '2025-07-06 06:14:28', '2025-07-06 06:14:28'),
	(25, 'Toyota Raize', 'toyota-raize', 'SUV cỡ nhỏ, năng động và linh hoạt.', '{"Động cơ": "1.0L Turbo", "Hộp số": "CVT"}', 'uploads/products/toyota-raize.jpg', 3, 5, 240, 552000000, '2025-07-06 06:14:28', '2025-07-06 06:14:28'),
	...
	(27, 'Toyota Fortuner Legender', 'toyota-fortuner-legender', 'SUV 7 chỗ mạnh mẽ, sang trọng.', '{"Động cơ": "2.8L Diesel", "Hộp số": "6 cấp tự động"}', 'uploads/products/fortuner.jpg', 3, 5, 220, 1470000000, '2025-07-06 06:14:28', '2025-07-06 06:14:28');
